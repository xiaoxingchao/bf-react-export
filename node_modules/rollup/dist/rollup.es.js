/*
  @license
	Rollup.js v0.68.0
	Sun, 16 Dec 2018 10:17:04 GMT - commit beac4844a34c1caf828d8070c538a9f38c98d80e
...
import path, { relative, basename, extname, dirname, resolve, sep } from 'path';
import { writeFile, readdirSync, mkdirSync, readFileSync, lstatSync, realpathSync, statSync, watch } from 'fs';
...
function umd(magicString, _a, options) {
    ...
    var globalDeps = trimmedImports.map(function (module) { return globalProp(module.globalName); });
    ...
    if (options.noConflict === true) {
        ...
        globalExport =
            "(function()" + _ + "{" + n +
                ...
                ("" + globalProp(options.name) + _ + "=" + _ + "current;" + _ + "return exports" + (options.compact ? '' : '; ') + "};" + n) +
                (t + "})()");
    }
    else {
        globalExport = defaultExport + "factory(" + globalDeps + ")";
    }
    var iifeNeedsGlobal = hasExports || (options.noConflict === true && namedExportsMode);
    var globalParam = iifeNeedsGlobal ? "global," + _ : '';
    var globalArg = iifeNeedsGlobal
    ...
    var cjsIntro = iifeNeedsGlobal
        ...
        : '';
    var wrapperIntro = "(function" + _ + "(" + globalParam + "factory)" + _ + "{" + n +
        cjsIntro +
...
var Chunk$1 = /** @class */ (function () {
    function Chunk(graph, orderedModules, inlineDynamicImports) {
        ...
        if (this.entryModules.length > 0) {
            this.variableName = makeLegal(basename(this.entryModules.map(function (module) { return module.chunkAlias; }).find(Boolean) ||
    ...
    Chunk.prototype.getDynamicImportIds = function () {
        return this.dynamicDependencies.map(function (chunk) { return chunk.id; });
    };
            ...
            for (var _i = 0, _a = module.dynamicImports; _i < _a.length; _i++) {
                ...
                if (resolution instanceof Module) {
                    ...
                    if (resolutionChunk && resolutionChunk !== this && resolutionChunk.id) {
                        var relPath = normalize(relative(dirname(this.id), resolutionChunk.id));
    ...
    Chunk.prototype.preRender = function (options, inputBase) {
        ...
        if (this.needsExportsShim) {
            magicString.prepend("" + n + this.graph.varOrConst + " " + MISSING_EXPORT_SHIM_VARIABLE + _ + "=" + _ + "void 0;" + n + n);
        }
        if (options.compact) {
...
pp$5.canDeclareVarName = function(name) {
  ...
  return !has$1(currentScope.lexical, name) && !has$1(currentScope.parentLexical, name)
};
...
pp$5.canDeclareLexicalName = function(name) {
  ...
  return !has$1(currentScope.lexical, name) && !has$1(currentScope.var, name) && !has$1(currentScope.childVar, name)
};
...
function assignChunkColouringHashes(entryModules, manualChunkModules) {
        ...
        for (var _i = 0, _d = Object.keys(manualChunkModules); _i < _d.length; _i++) {
            ...
            for (var _e = 0, _f = manualChunkModules[chunkName]; _e < _f.length; _e++) {
                ...
                if (currentEntry.chunkAlias) {
                    error({
                        code: 'INVALID_CHUNK',
                        message: "Cannot assign " + relative(process.cwd(), currentEntry.id) + " to the \"" + chunkName + "\" chunk as it is already in the \"" + currentEntry.chunkAlias + "\" chunk.\nTry defining \"" + chunkName + "\" first in the manualChunks definitions of the Rollup configuration."
                    });
                }
    ...
    for (var _h = 0, _j = Array.from(dynamicImports); _h < _j.length; _h++) {
        currentEntry = _j[_h];
...
var Graph = /** @class */ (function () {
    function Graph(options, watcher) {
        ...
        for (var _d = 0, _e = ['module', 'exports', '_interopDefault', MISSING_EXPORT_SHIM_VARIABLE]; _d < _e.length; _d++) {
            var name = _e[_d];
...
function assignChunkIds(chunks, singleChunk, inputOptions, outputOptions, inputBase, addons) {
    var usedIds = {};
    ...
    for (var i = 0; i < chunksForNaming.length; i++) {
        ...
        if (chunk === singleChunk) {
            singleChunk.id = basename(outputOptions.file ||
                (inputOptions.input instanceof Array ? inputOptions.input[0] : inputOptions.input));
        }
...
function getInputOptions$1(rawInputOptions) {
    ...
    if (!inputOptions.experimentalCodeSplitting) {
        ...
        if (inputOptions.experimentalOptimizeChunks)
            error({
                code: 'INVALID_OPTION',
                message: '"experimentalOptimizeChunks" option is only supported for experimentalCodeSplitting.'
            });
        ...
        return graph_1.pluginDriver
            ...
            function generate(rawOutputOptions, isWrite) {
                ...
                return graph_1.pluginDriver
                    ...
                    for (var _a = 0, chunks_4 = chunks; _a < chunks_4.length; _a++) {
                        var chunk = chunks_4[_a];
                    ...
                    assignChunkIds(chunks, singleChunk, inputOptions_1, outputOptions, inputBase, addons);
                    var _loop_1 = function (i) {
                        var chunk = chunks[i];
...
function createFilter ( include, exclude ) {
	const getMatcher = id => ( isRegexp$1( id ) ? id : { test: micromatch_1.matcher( resolve( id ).split ( sep ).join( '/' ) ) } );
...
export { rollup, watch$1 as watch, version$2 as VERSION };
