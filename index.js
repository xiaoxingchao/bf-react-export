...
console.log("running version ".concat(pkg.dependencies)); // 控制台输出 running version 1.0.0
...
printTarget.innerText = "sayHelloTo('Jason') => ".concat(res1, "\n\n");
printTarget.innerText += "addArray([1, 2, 3, 4]) => ".concat(res2);
